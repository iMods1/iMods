...
bool test_wbuffer_to_wbuffer() {
  ...
  wcerr << L"buffers equals: " << endl << L"-----------------" << endl
        << L"\t crc source:"
...
bool test_string_string() {
  ...
  cerr << "tests string-string,  char:" << endl
       << "----------------------------" << endl << "double : " << d << " "
       << d_r << endl << "char : " << c << " " << c_r << endl << "float : " << f
       << " " << f_r << endl << "unsigned int : " << ui << " " << ui_r << endl
       << "unsigned long : " << ul << " " << ul_r << endl
       << "unsigned short : " << us << " " << us_r << endl
       << "dummy class: " << dum << " " << dum_r << endl << endl;
    return true;
}

bool test_wstring_wstring() {
  // create some test values
...
bool test_file_file(bool add_gzip_header) {
  // create some test values
  char c_r = '-', c = 'a';
  ...
  {
    // creating the target zip string, could be a fstream
    ofstream ofstream_("/tmp/test.zip", ios::out | ios::binary);
    // creating the zip layer
  ...
  // create a stream on zip string
  ifstream ifstream_;
  ifstream_.open("/tmp/test.zip", ios::in | ios::binary);
...
bool test_crc() {
  ...
  {
    ofstream outFile("/tmp/test.gz", ios::out | ios::binary);
